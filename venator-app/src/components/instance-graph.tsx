...
export function InstanceGraph(props: InstanceGraphProps) {
    ...
    function cursor(): [number, number | null] | null {
        ...
        if (mouse != null) {
            ...
            return [props.hoveredRow.connected_at, props.hoveredRow.disconnected_at];
        } else {
            return null;
        }
    }
    ...
    createEffect(async () => {
        ...
        while (true) {
            ...
            previous = new_spans[new_spans.length - 1].connected_at;
        }
    ...
    return <div class="instance-graph-container" onwheel={wheel} onmousemove={mousedrag}>
        <div class="instance-graph-stats">{barHeightMax()} max
